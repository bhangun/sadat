...
public final class NodeDescriptor {
    ...
    // Compatibility shim
    public java.util.Set<String> capabilities() { return getCapabilities(); }
    ...
    public String implementation() { return getImplementationArtifact(); }
    ...
    // Compatibility shim
    public SandboxLevel sandboxLevel() { return getSandboxLevel(); }
    ...
    // Compatibility shim
    public java.util.List<tech.kayys.wayang.plugin.PortDescriptor> inputs() { return getInputs(); }
    ...
    // Compatibility shim
    public java.util.List<tech.kayys.wayang.plugin.PortDescriptor> outputs() { return getOutputs(); }
