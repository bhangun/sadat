...
public class AgentDefinition {
    ...
    public static class Builder {
        ...
        public Builder sandboxLevel(String sandboxLevel) {
            this.sandboxLevel = sandboxLevel;
            return this;
        }

        public Builder orchestration(OrchestrationSpec orchestration) {
            this.orchestration = orchestration;
            return this;
        }

        public Builder commerce(CommercePolicy commerce) {
            this.commerce = commerce;
            return this;
        }

        public Builder workflows(List<WorkflowDefinition> workflows) {
            this.workflows = workflows;
            return this;
        }
        ...
        public AgentDefinition build() {
            ...
            agent.setSandboxLevel(sandboxLevel);
            agent.setOrchestration(orchestration);
            agent.setCommerce(commerce);
