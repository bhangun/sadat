...
public class NotificationService {
     ...
     */
    public Uni<Void> sendTrialEndedNotification(Subscription sub) {
        String subject = "Trial Period Ended";
        String body = String.format("Calculated trial end date: %s", sub.trialEnd);
        return emailService.send(sub.organization.billingEmail, subject, body);
    }
